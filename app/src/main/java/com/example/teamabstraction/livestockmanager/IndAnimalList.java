...
{   private ListView individualAnimalListView;
    private ArrayAdapter<String> indvidialAnimaListAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        indvidialAnimaListAdapter = new ArrayAdapter<String>(this, R.layout.individual_animal_list_text_view, listOfIndvidualAnimalsArray);

        //Set the ArrayAdapter as the ListView's Adapter
        individualAnimalListView.setAdapter(indvidialAnimaListAdapter);
        ...
        individualAnimalListView.setOnItemClickListener(new AdapterView.OnItemClickListener()
        {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id)
            {
                ...
                Intent myIntent = new Intent(IndAnimalList.this, AnimalInfo.class);
